...
using Owin;
using FIT5032_Week5B.Models;

namespace FIT5032_Week5B
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            {
                ClientId = "378954399857-eu6874argokl3nhvh15el91r7l2rhf2g.apps.googleusercontent.com",
                ClientSecret = "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"
            });
        }
    }
}